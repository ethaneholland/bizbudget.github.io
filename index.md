    ...
    <div class="team-grid">
      ...
      <div class="team-card reveal">
        ...
        <div class="team-content">
          <div class="team-section">
            <p class="team-section-label">Contributions</p>
            <p class="team-bio">I wrote some unit tests, updated the architecture diagram and writeup, updated README, resolved feedback from previous iterations, created and managed feedback resolution tracking document, reviewed some merge requests, fixed some bugs.</p>
          </div>
          <div class="team-section">
            <p class="team-section-label">Skills Learned</p>
            <p class="team-bio">I learned how to write unit tests using Junit 5. I learned how to properly use git.
