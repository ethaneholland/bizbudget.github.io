        ...
        <div class="team-content">
          ...
          <div class="team-section">
            ...
            <p class="team-bio">I learned how to write unit tests using Junit 5, make an app using Android Studio, properly use git, plan a project using agile, and work better as a team of programmers. 
              <br>I learned the importance of unit testing to find errors in logic. I wrote a test that found an error in something that looked innocuous but was doing something we didn’t expect for certain cases.  
              <br>I learned the importance of separating platform-specific presentation code from business logic to allow for easy access to logic methods for unit testing. There were multiple instances where I was trying to write unit tests for a new service in the business layer, but I wasn’t easily able to inject test data into the service. In one case, it was getting data straight from user input. In another, the service needed an android specific object passed into its constructor which would need to be mocked. Both could only be tested with an instrumented test. We had to separate functionality from those classes so that the logic could be easily unit tested. </p>
          </div>
        </div>
      </div>
    </div>
